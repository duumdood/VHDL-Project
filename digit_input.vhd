...
entity digit_input is
    Port ( 
        clk        : in  STD_LOGIC;
        rst        : in  STD_LOGIC;
        btn_pulse  : in  STD_LOGIC_VECTOR(4 downto 0); -- [Center, Up, Down, Left, Right]
        val_out    : out STD_LOGIC_VECTOR(9 downto 0); -- 10-bit output (0-999)
        -- ส่งไปให้ 7-Seg
        digit_0    : out STD_LOGIC_VECTOR(3 downto 0); 
        digit_1    : out STD_LOGIC_VECTOR(3 downto 0);
        digit_2    : out STD_LOGIC_VECTOR(3 downto 0);
        cursor_pos : out STD_LOGIC_VECTOR(1 downto 0); -- 0=หน่วย, 1=สิบ, 2=ร้อย
        confirmed  : out STD_LOGIC                     -- Pulse ยืนยันการตั้งค่า
    );
end digit_input;
...
begin
    ...
    begin
        if rst = '1' then
            ...
            confirmed <= '0'; -- เคลียร์ pulse
            
            -- Left (bit 1) / Right (bit 0)
